...
## 今天完成了什么
- 完善 Projects 页面
- 添加项目列表、项目状态、技术栈和当前进度
- 学习了对象数组和嵌套 map

## 今天学到的东西
- 一个项目可以用对象描述
- 多个项目可以放进数组
- techStack 和 progress 也可以继续用 map 渲染
- Projects 页面是个人作品集的重要入口
...
## 今天完成了什么
- 创建个人网站项目详情页
- 在 Projects 页面添加详情页入口
- 学习了嵌套路由

## 今天学到的东西
- app/projects/personal-site/page.tsx 对应 /projects/personal-site
- 项目列表页面可以链接到项目详情页
- 一个项目可以拆成列表入口和详情展示
...
## 今天学到的东西
- slug 是文章在 URL 中的名字
- /blog/day-1-create-site 对应 app/blog/day-1-create-site/page.tsx
- Blog 页面和 Projects 页面结构类似，但内容更偏文章和日志
...
- 创建 Day 2 文章详情页
- 让 Blog 列表可以跳转到第二篇文章
- 复习了 Next.js App Router 的路由规则

## 今天学到的东西
- app/blog/day-2-nextjs-routing/page.tsx 对应 /blog/day-2-nextjs-routing
- Blog 列表通过 href 跳转到文章详情页
- 多篇文章之间会出现重复结构，后续可以通过组件抽取优化
